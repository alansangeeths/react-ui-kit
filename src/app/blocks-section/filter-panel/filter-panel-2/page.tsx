                ...
                return (
                    <section className="bg-white dark:bg-gray-800">
                        ...
                        <div className="p-3 absolute top-0 right-0">
                            <ButtonComponent cssClass="e-large e-round" iconCss="e-icons e-chevron-left " type="button" onClick={() => dialogRef.current?.show()}></ButtonComponent>
                        </div>
                        {/* SB Code - End */}
                    </section>
                );
                                ...
                                <div className="dialog-content">
                                    ...
                                    <div className={`border rounded-3 ${recordData !== 0 ? "pt-1" : ""}`}>
                                        ...
                                        <div className={`p-3 rounded-bottom-3 ${recordData !== 0 ? "border-top" : ""}`}>
                                            <ButtonComponent cssClass="e-primary e-flat" iconCss="e-icons e-plus" type="button" content="Add New" onClick={() => queryBuilder2Ref.current?.addRules([{}], "group0")}></ButtonComponent>
                                        </div>
                                    </div>
                                </div>
                            </DialogComponent>
