                ...
                return (
                    <section>
                        <div id="dialog-container" className="relative flex justify-center" style={{ minHeight: "580px" }}>
                            ...
                            <DialogComponent ref={dialog} className="rounded-none sm:rounded-lg sm:m-4" target="#dialog-container" open={(e) => { e.preventFocus = true; }} showCloseIcon={true} width="660px" isModal={true}
                                header={() => (
                ...
                return (
                    <section>
                        <div id="dialog-container" className="position-relative d-flex align-items-start" style={{ minHeight: "580px" }}>
                            <ButtonComponent className="mx-auto my-3" type="button" onClick={() => dialog.current?.show()}>Submit Feedback</ButtonComponent>
                            <DialogComponent ref={dialog} className="rounded-3 m-sm-2" target="#dialog-container" open={(e) => { e.preventFocus = true; }} showCloseIcon={true} width="660px" isModal={true}
                                header={() => (
