                ...
                return (
                    <section>
                        <div id="dialog-container" className="relative flex justify-center" style={{ minHeight: containerHeight }}>
                            ...
                            <DialogComponent id={styles["dialogs"]} key={"modal-2-tw"} className="rounded-none sm:rounded-lg sm:m-4" width="492px" ref={dialog} isModal={true} showCloseIcon={true} beforeOpen={(event) => { event.maxHeight = '766px'; }} open={(e) => { e.preventFocus = true; }} 
                                ...
                                footerTemplate={() => (
                                    <div className="flex flex-row justify-end gap-2 sm:gap-1 mt-1 mb-2">
                                        ...
                                        <ButtonComponent cssClass="e-primary grow sm:grow-0" type="button">Create Ticket</ButtonComponent>
                                    </div>
                                )}
                            >
                            ...
                            <DialogComponent id={styles["dialogs"]} key={"modal-2-bs"} className="rounded-3 m-sm-2" ref={dialog} target="#dialog-container" isModal={true} showCloseIcon={true} width="492px" open={(event) => (event.preventFocus = true)} beforeOpen={(event) => (event.maxHeight = "790px")}
                                ...
                                footerTemplate={() => (
                                    <div className="d-flex justify-content-end gap-2 gap-sm-1 py-1">
                                        ...
                                        <ButtonComponent cssClass="e-primary flex-grow-1 flex-sm-grow-0" type="button">Create Ticket</ButtonComponent>
                                    </div>
                                )}
                            >
