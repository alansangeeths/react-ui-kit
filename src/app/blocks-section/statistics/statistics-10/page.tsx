                                ...
                                {metricsData.map((data, index) => (
                                    <div key={index} className="e-card pt-6 e-bigger rounded-lg shadow-none !border-gray-300 dark:!border-gray-600">
                                        <div className="e-card-stacked">
                                            <div className="e-card-header !py-0 !justify-start items-center">
                                                <span className={`e-avatar e-avatar-small e-avatar-circle ${data.metricName === "Impressions" ? "bg-orange-100 dark:bg-orange-800 text-orange-700 dark:text-orange-500" : data.metricName === "Active Users" ? "bg-indigo-100 dark:bg-indigo-800 text-indigo-600 dark:text-indigo-400" : data.metricName === "User Engagements" ? "bg-green-100 dark:bg-green-800 text-green-700 dark:text-green-500" : "bg-cyan-100 dark:bg-sky-800 text-cyan-700 dark:text-sky-400"}`}>
                                            ...
                                            <div className="e-card-content !pb-6 !pt-4 flex flex-col xl:flex-row">
                                                <span className="text-xl font-semibold text-gray-900 dark:text-white mr-0 xl:mr-2">{data.currentValue}</span>
                                                <div className="flex justify-between items-center mt-1 xl:mt-0 grow">
                                                    ...
                                                    <span className={`gap-1 flex items-center ${data.currentPercentage > 0 ? "text-green-700 dark:text-green-500" : "text-red-600 dark:text-red-400"}`}>
                                                        <span className={`e-icons e-medium ${data.currentPercentage > 0 ? "e-arrow-up" : "e-arrow-down"}`}></span>
                                ...
                                {metricsData.map((data, index) => (
                                    <div key={index} className="col-12 col-sm-6 col-lg-3">
                                        <div className="e-card rounded-3 e-bigger pt-4">
                                            <div className="e-card-stacked">
                                                <div className="e-card-header py-0 px-4 justify-content-start align-items-center">
                                                ...
                                                <div className="e-card-content pb-4 px-4 pt-3 d-flex flex-column flex-xl-row">
                                                    <span className="fs-5 lh-sm fw-bold text-body me-0 me-xl-2">{data.currentValue}</span>
                                                    <div className="d-flex justify-content-between align-items-center mt-1 mt-xl-0 flex-grow-1">
