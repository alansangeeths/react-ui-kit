...
export default function Unlocksession1() {
    ...
    const handleMessageEvent = (event: MessageEvent) => {
        if (event.origin === window.location.origin) {
            try {
                ...
                if (blockData.name === 'unlock-session-1' && blockData.theme) {
    ...
    const getContent = () => {
        switch (theme) {
            case 'tailwind':
                return (
                    <section className="bg-gray-50 dark:bg-gray-950 min-h-screen flex justify-center">
            ...
            case 'bootstrap5':
                return (
                    <section className="d-flex justify-content-center bg-body min-vh-100" key={"unlock1"}>
